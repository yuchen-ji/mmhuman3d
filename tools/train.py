...
def parse_args():
    ...
    parser.add_argument('--config', default='configs/ormr/hrnet_w32_only.py', help='train config file path')
    parser.add_argument('--work-dir', default='workspace/ormr/only', help='the dir to save logs and models')
    parser.add_argument(
